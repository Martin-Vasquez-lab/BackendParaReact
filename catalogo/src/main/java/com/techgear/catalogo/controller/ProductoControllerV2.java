...
public class ProductoControllerV2 {
    ...
    public ResponseEntity<EntityModel<Producto>> insertarProductoV2(@RequestBody Producto producto) {
    ...
    public ResponseEntity<EntityModel<Producto>> actualizarProductoV2(@RequestBody Producto producto) {
    Producto updProducto = productoService.saveProducto(producto);
    return ResponseEntity
            .ok(assembler.toModel(updProducto));
    }
