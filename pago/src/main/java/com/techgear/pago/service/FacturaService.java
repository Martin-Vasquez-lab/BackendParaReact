...
public class FacturaService {
    ...
    public Factura processPaymentWithStockValidation(Factura factura) throws Exception {
        ...
        // 2. Validar stock para el producto en el carrito
        Map<String, Object> producto = (Map<String, Object>) carroData.get("producto");
        if (producto == null) {
            throw new Exception("Producto no encontrado en el carrito");
        }
        Integer productId = (Integer) producto.get("id");
        Integer cantidad = (Integer) carroData.get("cantidad");
